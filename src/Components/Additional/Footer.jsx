        ...
        <Box sx={{ maxWidth: '1200px', mx: 'auto' }}>
          <Grid container spacing={4}>
            ...
            <Grid item xs={12} sm={6} md={4} sx={{ fontSize: '25px' }}>
              ...
              <Typography sx={{ display: 'flex', alignItems: 'center', gap: 1, mb: 1, color: '#3c3c3c', fontSize: "20px" }}>
                <FaMapMarkerAlt /> Demo street Abc colony City - 001 000
              </Typography>
              <Typography sx={{ display: 'flex', alignItems: 'center', gap: 1, mb: 1, color: '#3c3c3c', fontSize: "20px" }}>
                <FaPhoneAlt /> +91 92356 54879
              </Typography>
              <Typography sx={{ display: 'flex', alignItems: 'center', gap: 1, color: '#3c3c3c', fontSize: "20px" }}>
            ...
            <Grid item xs={6} sm={3} md={2} sx={{ fontSize: '25px' }}>
              ...
              {['Home', 'About Us', 'Categories', 'Brands', 'Contact'].map((item) => (
                <Typography 
                  key={item}
                  sx={{ mb: 3, color: '#3c3c3c', cursor: 'pointer', '&:hover': { color: '#b68c6b' }, fontSize: "20px" }}>
                  {item}
                </Typography>
              ))}
            </Grid>
            ...
            <Grid item xs={12} sm={6} md={4} sx={{ fontSize: '25px' }}>
              ...
              <Typography sx={{ mb: 3, color: '#3c3c3c', fontSize: "20px" }}>
